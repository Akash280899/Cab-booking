  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item ">
       ...
       <li class="nav-item">
        <a class="nav-link" href="/aboutUs"><i class="fas fa-globe"></i></i></i><strong> ABOUT</strong></a>
      </li>
...
<div class="head ">
  ...
  <p class="bounceIn animated">Experience the best Rides in your city.</p>
   ...
   <a href="/cosdriv"><button type="button" class="btn btn-success btn-lg mybtn" style="vertical-align:middle"><span>Lets Ride </span></button></a>
