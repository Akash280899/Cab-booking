...
<nav class="navbar navbar-dark bg-dark">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <p class="nav_p">
   <c:set var="log" scope="session" value="${sessionScope.logged }"/>  
   <c:choose>
  <c:when test="${log == 'yes'}">
  ...
  <c:otherwise>
    <button onclick="location.href='/loginIndex'" type="button" class="btn btn-primary mybtn">Login</button>
  </c:otherwise>
</c:choose>
   </p>
  </div>
...
<c:choose>
  <c:when test="${driverId == ID && status=='pending' }">	 
     <div class="container">
 <div class="row">
  <div class="col sm-6 ">
...
<button value="lets" type="submit" class="btn btn-success " style="vertical-align:middle" name="letsButton1">Accept</button>
<% 
