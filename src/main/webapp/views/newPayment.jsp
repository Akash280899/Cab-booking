...
<head>
  ...
  <title data-tid="elements_examples.meta.title">V Cabs</title>
 ...
 <div class="globalContent">
    ...
    <section class="container-lg">
        ...
        <form>
          <fieldset>
            ...
            <div class="row">
              ...
              <input id="example1-name" data-tid="elements_examples.form.name_placeholder" type="text" placeholder="User name" required="" autocomplete="name">
            </div>
            <div class="row">
              <label for="example1-email" data-tid="elements_examples.form.email_label">Email</label>
              <input id="example1-email" data-tid="elements_examples.form.email_placeholder" type="email" placeholder="user@gmail.com" required="" autocomplete="email">
            </div>
            <div class="row">
              <label for="example1-phone" data-tid="elements_examples.form.phone_label">Phone</label>
              <input id="example1-phone" data-tid="elements_examples.form.phone_placeholder" type="tel" placeholder="Phone number" required="" autocomplete="tel">
            </div>
          </fieldset>
          <fieldset>
            <div class="row">
        ...
        <div class="success">
          ...
          <p class="message"><span data-tid="elements_examples.success.message">Thanks for using V cabs. We hope you enjoyed your ride!! </span>Payment Id:<span class="token"></span></p>
          <a class="reset" href="/">
            ...
            <a href="/"><button type="button" class="btn btn-success mybtn1" style="vertical-align:middle"><span>Back to Home</span></button></a> 
          </a>
        </div>
      </div>
