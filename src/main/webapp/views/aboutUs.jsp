    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
       ...
       <li class="nav-item active">
        <a class="nav-link" href="/aboutUS"><i class="fas fa-globe"></i><strong> ABOUT <span class="sr-only">(current)</span></strong></a>
      </li>
...
<div class="row">
  <div class="col-sm-4">
    ...
    <div class="card">
      <img class="card-img-top" src="assests/av2.png" >
      <div class="card-body">
  ...
  <div class="col-sm-4">
    <div class="card">
      <img class="card-img-top" src="assests/av1.png" >
      <div class="card-body">
        <h5 class="card-title">AKJ</h5>
        <p class="card-text"> Designation : Driver</p>
  ...
  <div class="col-sm-4">
    <div class="card">
      <img class="card-img-top" src="assests/av3.jpg"  style="height: 350px;">
      <div class="card-body">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-6 whyR" style="margin-bottom: 20px;">
            <div style="width: 40%; float: left;color: black;">
                <img src="assests/y2.jpg"/>
                
            </div>
            <div style="width: 60%; float: left;color: grey;">
                <h5>V CAB Select</h5>
                <p>A membership program with V cab that lets you ride a Prime Sedan at Mini fares, book cabs without peak pricing and has zero wait time  </p>
            </div>
        </div>
        <div class="col-md-6 whyR" style="margin-bottom: 20px;">
            <div style="width: 40%; float: left;color: black;">
                <img src="assests/y3.jpg"/>
                
            </div>
            <div style="width: 60%; float: left;color: grey;">
                <h5>Share and Express </h5>
                <p>To travel with the lowest fares choose V cab Share. For a faster travel experience we have Share Express on some fixed routes with zero deviations. Choose your ride and zoom away! </p>
            </div>
        </div>
        <div class="col-md-6 whyR" style="margin-bottom: 20px;">
            <div style="width: 40%; float: left;color: black;">
                <img src="assests/y4.jpg"/>
        ...
        <div class="col-md-6 whyR" style="margin-bottom: 20px;">
            <div style="width: 40%; float: left;color: black;">
                <img src="assests/y5.jpg"/>
                
            </div>
            <div style="width: 60%; float: left;color: grey;">
                <h5>In Cab Entertainment </h5>
                <p>Play music, watch videos and a lot more with V Play! Also stay connected even if you are travelling through poor network areas with our free wifi facility. </p>
            </div>
        </div>
        <div class="col-md-6 whyR" style="margin-bottom: 20px;">
            <div style="width: 40%; float: left;color: black;">
                <img src="assests/y6.jpg"/>
                
            </div>
            <div style="width: 60%; float: left;color: grey;">
                <h5>Cashless Rides </h5>
                <p>Now go cashless and travel easy. Simply add your credit/debit card to enjoy hassle free payments. 
</p>
            </div>
        </div>
    </div>
